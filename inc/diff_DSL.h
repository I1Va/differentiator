...
#define _VAR()          bin_tree_create_node(NULL, NULL, {NODE_VAR,  {0     , 0ll, 0ll, NULL}})
#define _NUM(val)       bin_tree_create_node(NULL, NULL, {NODE_NUM,  {0     , val, 0ll, NULL}})
#define _FUNC(n2, name) bin_tree_create_node(NULL, n2,   {NODE_FUNC, {0     , 0ll, 0ll, name}})
